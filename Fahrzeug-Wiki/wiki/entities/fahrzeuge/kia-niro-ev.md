...
kategorie: "fahrzeug"
hersteller: "Kia"
segment: "Kompakt-SUV / Crossover"
karosserie: "Crossover (SUV)"
bauzeit: "seit 2018"
plattform: "Mehrenergie-Plattform des Niro (Hybrid, Plug-in-Hybrid, Elektro; keine E-GMP)"
varianten: 3
brutto_min: 42.0
brutto_max: 68.0
netto_min: 39.2
netto_max: 64.8
bild: "Bilder/kia-niro-ev.jpg"
updated: "2026-09-24"
sources: 1
tags: ["fahrzeug", "kia", "kompakt-suv-crossover"]
---

# Kia e-Niro / Niro EV

![Kia e-Niro / Niro EV](../../../Bilder/kia-niro-ev.jpg)
...
|---|---|---|---|---|
| e-Niro | 42 kWh | 39,2 kWh | 2,8 kWh (6,7 %) | 149 |
| e-Niro | 67,5 kWh | 64 kWh | 3,5 kWh (5,2 %) | 150 |
| Niro EV | 68 kWh | 64,8 kWh | 3,2 kWh (4,7 %) | 173 |

Quelle: [[tn-batterycheck-alle-daten]], Blatt „Fahrzeuge“, Zeilen 149–173 – bereinigte Fassung (Stand 2026-09-24, Änderungen in [[datenqualitaet]]). Puffer = Brutto − Netto (berechnet).
